...
export default function Food() {
  ...
  const currentPage = paginationState.foodPage; 
  const currentPageNumbers = paginationState.foodCurrentPageNumbers;
  ...
  useEffect(() => {
    if (data && data.data) {
      if (previousData !== data.data) {
        updatePage('foodPage', 1);
        updateCurrentPageNumbers('food', []);
      ...
      <section className="content">
        <div className="content__title-box" id='content'>
          <h1 className="content__title">
            Еда в <span className="content__city">{cityName}</span>
        ...
        {isLoading ?
          ...
          <Content 
            ...
            setCurrentPage={(page) => { updatePage('foodPage', page); }} 
            totalCount={totalCount}
            currentPageNumbers={currentPageNumbers}
            updateCurrentPageNumbers={(numbers) => updateCurrentPageNumbers('food', numbers)}
