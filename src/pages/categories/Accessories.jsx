...
export default function Accessories() {
  ...
  const currentPage = paginationState.accessoriesPage; 
  const currentPageNumbers = paginationState.accessoriesCurrentPageNumbers;
  ...
  useEffect(() => {
    if (data && data.data) {
      if (previousData !== data.data) {
        updatePage('accessoriesPage', 1);
        updateCurrentPageNumbers('accessories', []);
      ...
      <section className="content">
        <div className="content__title-box" id='content'>
          <h1 className="content__title">
            Аксессуары в <span className="content__city">{cityName}</span>
        ...
        {isLoading ?
          ...
          <Content 
            ...
            setCurrentPage={(page) => { updatePage('accessoriesPage', page); }} 
            totalCount={totalCount}
            currentPageNumbers={currentPageNumbers}
            updateCurrentPageNumbers={(numbers) => updateCurrentPageNumbers('accessories', numbers)}
