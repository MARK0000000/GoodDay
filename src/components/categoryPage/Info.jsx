...
export default function Info() {
  ...
  return (
    <section className='info'>
      <h4 className="info__h4">Скидки и акции в лучших заведениях Полоцка и Новополоцка</h4>
      <p className="info__text info__text_first">
        Скидками пользуется весь мир и они давно воспринимаются людьми как способ разумной экономии. Поэтому Good Day с радостью приблизит к миру, где скидки и акции - выгодно, приятно и удобно. Сэкономить в Полоцке и Новополоцке можно на посещении ресторана, салона красоты, медицинского центра, на покупке товаров и билетов на любые развлечения.
      </p>
