...
export const SkeletonPosterPageMedia = () => (
  <ContentLoader
    speed={2}
    height={970}
    width='100%'
  ...
  >
    ...
    {/* widget right bottom */}
    <rect x="0" y="63%" rx="6" ry='6' width='10%' height='2%' />

    <rect x="00" y="66%" rx="6" ry='6' width='30' height='30' />
    <rect x="0" y="66%" rx="6" ry='6' width='30' height='30' />
    <rect x="40" y="66%" rx="6" ry='6' width='30' height='30' />
    <rect x="80" y="66%" rx="6" ry='6' width='30' height='30' />
    <rect x="120" y="66%" rx="6" ry='6' width='30' height='30' />
    <rect x="170" y="66%" rx="6" ry='6' width='30' height='30' />

    <rect x="80%" y="66%" rx="6" ry='6' width='20%' height='40' />
