...
import { SkeletonContentServices } from '../UI/loaders/SkeletonContetServices'
import { useNavigate } from 'react-router';

export default function ContentServices({data, isLoading, showMoreCards}) {
    ...
    return (
        <>
            {isLoading ?
            <>
                <SkeletonContentServices style={{marginRight: "20px"}}/>
                <SkeletonContentServices style={{marginRight: "20px"}}/>
                ...
                {cards.map((item, index) => 
                    <article className='service' key={index}>
                        ...
                        <div className="service__bottom">
                            ...
                            <span></span>
                            <button onClick={() => navigate(`${item.id}`, { replace: false })} className="service__button">Записаться</button>
                        </div>
                    </article>
                )}        
            </div>
